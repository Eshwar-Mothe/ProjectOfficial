            ...
            {[
              {
                ...
                bio: 'With over a decade of experience in international tax compliance, Rohan envisioned a platform that bridges global complexity with simplicity.'
              },
              {
                name: 'Sarah Lin',
                initials: 'SL',
                ...
                bio: 'Sarah brings operational excellence from fintech and edtech startups. Her passion is building customer-first journeys that deliver results.'
              }
            ].map((leader, i) => (
