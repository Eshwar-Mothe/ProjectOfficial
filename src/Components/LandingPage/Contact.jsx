...
function Contact() {
  ...
  const contactMethods = [
    ...
    },
    {
      icon: Mail,
      title: 'Email Us',
      primary: 'support@taxpro-usa.com',
    ...
    },
    {
      icon: MapPin,
      title: 'Visit Us',
      primary: '123 Tax Street, Suite 100',
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: 'Our pricing is transparent and competitive. Simple returns start at $49, while complex returns with multiple schedules range from $149-$299. We offer a price match guarantee and no hidden fees. You\'ll know the exact cost before we begin.'
    },
    {
                ...
                {contactMethods.map((method, index) => (
                  <div
                    ...
                    style={{
                      ...
                      transform: isVisible[`method-${index}`] ? 'translateY(0) scale(1)' : 'translateY(50px) scale(0.9)',
              ...
              >
                <div className="info-card">
                  ...
                  <div className="quick-contact-options">
                    <a href="tel:+15551234567" className="quick-contact-btn phone">
                      <Phone size={20} />
                      <div>
